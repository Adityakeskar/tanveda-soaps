...
const products = [
  { img: soap1, name: "Lavender & Rosemary", desc: "Calming herbal blend for a soothing bathing experience." },
  { img: soap2, name: "Charcoal & Tea Tree", desc: "Deep cleansing charcoal soap with purifying tea tree oil." },
  { img: soap3, name: "Turmeric & Sandalwood", desc: "Golden glow bar infused with turmeric and sandalwood." },
];
