    ...
    <div className="max-w-5xl mx-auto text-center relative z-10">
      ...
      <div className="grid md:grid-cols-3 gap-10">
        {features.map((f, i) => (
          ...
          >
            <div className="absolute inset-0 rounded-2xl bg-primary/5 scale-95 group-hover:scale-100 transition-transform duration-300" />
            <div className="relative p-5 flex flex-col items-center text-center">
              <div className="w-11 h-11 rounded-full bg-primary/10 flex items-center justify-center mb-3 group-hover:bg-primary/20 transition-colors">
