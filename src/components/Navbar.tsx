      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-2">
        <a href="#" className="flex items-center gap-3 shrink-0">
          <img
            src={logo}
            alt="Tanveda logo"
            className="h-12 w-12 rounded-full object-cover brightness-[0.85] contrast-[1.1] transition-all duration-300 hover:scale-[2.5] hover:z-50 hover:shadow-2xl hover:rounded-2xl hover:brightness-100 hover:contrast-125"
          />
